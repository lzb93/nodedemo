  ...
  <section>
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="100">
      ...
      <FormItem label="简介" prop="description">
        <Input v-model="formValidate.description" placeholder="简介"></Input>
      </FormItem>
      <FormItem label="分类" v-if="categoryList.length > 0">
    ...
    methods: {
      ...
      async _getAbout() {
        try {
          ...
          this.formValidate.title = About.title;
          this.formValidate.author = About.author;
          this.formValidate.category_id = parseInt(About.category_id);
          this.formValidate.cover = About.cover;
          this.formValidate.content = About.content;
          this.formValidate.description = About.description;
      ...
      async _updateAbout() {
        ...
        try {
          await this.updateAbout(this.formValidate);
